...
<div class="step-container">
    <div class="step-indicator">
        ...
        <div class="step-title">Upload de bronbestanden {help_tooltip}</div>
    </div>
""", unsafe_allow_html=True)
...
<div class="step-container">
    <div class="step-indicator">
        ...
        <div class="step-title">Configureer betrouwbaarheidsdrempel {help_tooltip}</div>
    </div>
...
<div class="step-container">
    <div class="step-indicator">
        ...
        <div class="step-title">Start de URL matching {help_tooltip}</div>
    </div>
""", unsafe_allow_html=True)
        ...
        if results:
            ...
            <div class="step-container">
                <div class="step-indicator">
                    ...
                    <div class="step-title">Resultaten {help_tooltip}</div>
                </div>
            """, unsafe_allow_html=True)
...
st.markdown("""
<div class="footer">
    URL Redirect Mapper | Eenvoudige URL matching met betrouwbaarheidsscores<br>
    © 2023 Dibbes
</div>
""", unsafe_allow_html=True) 
